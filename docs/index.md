...
- Guided setup launchers for Windows, macOS, and Linux, plus a Cursor deeplink for simpler installation.
...
For guided platform setup, start with [One-Click Install](one-click-install.md).
